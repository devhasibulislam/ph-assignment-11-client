                    ...
                    <div class="flex flex-wrap -m-4">
                        <div class="p-4 lg:w-1/3">
                            <div class="h-full bg-gray-100 bg-opacity-75 px-8 pt-16 pb-24 rounded-lg overflow-hidden text-center relative">
                                <h2 class="tracking-widest text-xs title-font font-medium text-gray-400 mb-1">QUESTOIN 01</h2>
                                ...
                                <button class="text-indigo-500 inline-flex items-center" onClick={()=>setCollapse(!collapse)}> Learn More
                        ...
                        <div class="p-4 lg:w-1/3">
                            <div class="h-full bg-gray-100 bg-opacity-75 px-8 pt-16 pb-24 rounded-lg overflow-hidden text-center relative">
                                <h2 class="tracking-widest text-xs title-font font-medium text-gray-400 mb-1">QUESTION 03</h2>
                                <h1 class="title-font sm:text-2xl text-xl font-medium text-gray-900 mb-3">Difference between SQL & NoSQL database</h1>
                                <p class="leading-relaxed mb-3 text-justify">
                                    {
                                        collapse ? 'SQL are relational and NoSQL are non-relational. SQL databases use structured query language and have a predefined schema. NoSQL databases have dynamic schemas for unstructured data.' : 'SQL are relational and NoSQL are non-relational. SQL databases use structured query language and have a predefined schema. NoSQL databases have dynamic schemas for unstructured data. SQL databases use vertically managed approach, while NoSQL databases use horizontally managed approach. SQL databases are table-based, while NoSQL databases use document, key-value'
                                    }
                                </p>
                                <button class="text-indigo-500 inline-flex items-center" onClick={() => setCollapse(!collapse)}> Learn More
                                    <svg class="w-4 h-4 ml-2" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2" fill="none" stroke-linecap="round" stroke-linejoin="round">
